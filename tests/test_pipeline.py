...
class TestProcessEntity:
    def test_process_entity_creates_parquet_with_expected_schema(
        self, mocker, validated_fixtures, tmp_path
    ):
        # Given
    ...
    def test_process_entity_logs_error_when_key_is_missing(self, mocker, caplog):
        # Given
        entity_name = "fixtures"
        url = "http://mock-api.com/fixtures"
    ...
    def test_process_entity_logs_warning_when_no_data_processed(self, mocker, caplog):
        # Given
        entity_name = "fixtures"
        url = "http://mock-api.com/fixtures"
        filename = "fixtures.parquet"
